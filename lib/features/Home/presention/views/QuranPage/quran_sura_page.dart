...
import 'package:roken_al_raha/features/Home/presention/views/QuranPage/SurahView/widgets/surah_loading_view.dart';
    ...
    return Scaffold(
      ...
      body: isLoading
          ...
          : ListView(
              ...
              children: [
                LastReadCard(surahJsonData: widget.suraJsonData),
                TextField(
                ...
                ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String suraNameTranslated = filteredData[index]["name"]
                        .toString();
